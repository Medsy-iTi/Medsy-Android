...
13. **Always make a plan before every big feature or decision, and ask questions if you need clarification.** Follow the planning mode guidelines strictly, ensuring the implementation plan is created/updated, feedback is requested, and approval is obtained before execution.
